const RemiliasRegistrar = require('./build/contracts/RemiliasRegistrar.json')
const RemiliasNameWrapper = require('./build/contracts/RemiliasNameWrapper.json')
const RemiliasPublicResolver = require('./build/contracts/RemiliasPublicResolver.json')
const RemiliasResolver = require('./build/contracts/RemiliasResolver.json')
const RemiliasRegistrarController = require('./build/contracts/RemiliasRegistrarController.json')
